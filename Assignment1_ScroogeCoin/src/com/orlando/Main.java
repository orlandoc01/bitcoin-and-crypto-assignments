...
public class Main {
  ...
  public static void main(String[] args) throws NoSuchProviderException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
    ...
    final IsValidTest isValidTest = new IsValidTest();
    isValidTest.testIsValidWithValidTransactions();
    isValidTest.testIsValidWithInvalidSignatures();
    isValidTest.testIsValidSignaturesWithInvalidPrivateKeys();
    isValidTest.testIsValidTotalOutputExceedsTotalInput();
    isValidTest.testIsValidTransactionsClamingOuputsNotInThePool();
    isValidTest.testIsValidTransactionsClaimingTheSameUTXOSeveralTimes();
    isValidTest.testIsValidTransactionsWithNegativeOutput();
  }
